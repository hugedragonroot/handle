...
#define BREAK1_READ_INPUT()	HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_8)
#define BREAK2_READ_INPUT()	HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_15)


#define KEY_BOTTOM_INPUT() 	 HAL_GPIO_ReadPin(GPIOF, GPIO_PIN_3)
#define KEY_TOP_INPUT()			 HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_5)
